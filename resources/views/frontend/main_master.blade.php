    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <div class="row">
        ...
        <div class="col-md-4">
            <ul class="list-group">
              <li class="list-group-item">Product Price: <strong class="text-danger"><i class="fa fa-inr" aria-hidden="true"></i><span id="pprice"></span></strong>
              <del id="oldprice"></del>
              </li>              
    ...
    function productView(id){
        ...
        $.ajax({
            ...
            if (data.product.discount_price == null) {
                $('#pprice').text('');
                $('#oldprice').text('');
                $('#oldprice').removeClass('fa fa-inr');
                $('#pprice').text(data.product.selling_price);
            }else{
                $('#pprice').text(data.product.discount_price);
                
               $('#oldprice').attr('class','fa fa-inr');
