      ...
      @include('frontend.common.vertical_menu')
                      ...
                      <div class="row product-micro-row">
                        <div class="col col-xs-5">
                          <div class="product-image">
                            ...
                            <img  src="{{asset($product->product_thumbnail)}}" alt=""></a> </div>                            <!-- /.image --> 
        ...
        @if(session()->get('language') == 'hindi') {{ $product->product_name_hi }}
           @else {{ $product->product_name_en }} @endif</a></h3>
                            ...
                            <div class="product-price"> <span class="price"><i class="fa fa-inr" aria-hidden="true"></i> {{$product->selling_price}} </span> </div>
                            <!-- /.product-price --> 
        ...
        <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
          <div class="more-info-tab clearfix ">
            ...
            <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
              ...
              @if(session()->get('language') == 'hindi') सभी
              @else All @endif
              </a></li>
          ...
          <div class="tab-content outer-top-xs">
            <div class="tab-pane in active" id="all">
              <div class="product-slider">
                ...
                @foreach($products as $product) <!--product foreach start -->
                    ...
                    <div class="products">
                      <div class="product">
                        ...
                        <div class="product-info text-left">
                          ...
                          @if($product->discount_price == NULL)
                          <span class="price-before-discount"><i class="fa fa-inr" aria-hidden="true"></i>{{$product->selling_price}}</span> 

                          @else

                            <span class="price"><i class="fa fa-inr" aria-hidden="true"></i> {{$product->discount_price}} </span>
                            <span class="price-before-discount"><i class="fa fa-inr" aria-hidden="true"></i>{{$product->selling_price}}</span> 
                          @endif
                          </div>
                          <!-- /.product-price --> 
...
<button class="btn btn-primary icon" type="button" title="Wishlist" id="{{ $product->id }}" onclick="addToWishList(this.id)"> <i class="fa fa-heart"></i> </button>
            ...
            @foreach($categories as $category)   <!--category foreach start-->
            <div class="tab-pane" id="category{{$category->id}}">
              <div class="product-slider">
                ...
                @forelse($catwiseProduct as $product) <!--product foreach start -->
                <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
...
<button class="btn btn-primary icon" type="button" title="Wishlist" id="{{ $product->id }}" onclick="addToWishList(this.id)"> <i class="fa fa-heart"></i> </button>
                ...
                @endforelse <!--product foreach end-->
                </div>
                <!-- /.home-owl-carousel --> 
              </div>
              <!-- /.product-slider --> 
            </div>
            @endforeach  <!--category foreach end-->
            <!-- /.tab-pane -->
              ...
              <div class="products">
                <div class="product">
                  ...
                  <div class="product-info text-left">
                    ...
                    <div class="product-price"> 
                      @if($product->discount_price == NULL)
                      <span class="price"><i class="fa fa-inr" aria-hidden="true"></i>{{$product->selling_price}}</span> 
        ...
        <section class="section featured-product wow fadeInUp">
          ...
          @if(session()->get('language') == 'hindi') {{ $skip_category_0->category_name_hi }}
...
<button class="btn btn-primary icon" type="button" title="Wishlist" id="{{ $product->id }}" onclick="addToWishList(this.id)"> <i class="fa fa-heart"></i> </button>
  ...
  <section class="section featured-product wow fadeInUp">
          <h3 class="section-title">
          @if(session()->get('language') == 'hindi') {{ $skip_category_1->category_name_hi }}
...
<button class="btn btn-primary icon" type="button" title="Wishlist" id="{{ $product->id }}" onclick="addToWishList(this.id)"> <i class="fa fa-heart"></i> </button>
 ...
 <section class="section featured-product wow fadeInUp">
          <h3 class="section-title">
          @if(session()->get('language') == 'hindi') {{ $skip_brand_5->brand_name_hi }}
                        @else {{ $skip_brand_5->brand_name_en }} @endif
          </h3>
          <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
                ...
                <div class="blog-post">
                  <div class="blog-post-image">
                    <div class="image"> <a href="blog.html">
                      <img src="{{ asset($blog->post_image) }}" alt=""></a> </div>
                  </div>
                  <!-- /.blog-post-image -->
                  
                  <div class="blog-post-info text-left">
                    <h3 class="name"><a href="blog-details.html"> @if(session()->get('language') == 'hindi') {{ $blog->post_title_hin }} @else {{ $blog->post_title_en }} @endif</a></h3>
                    <span class="info">{{ Carbon\Carbon::parse($blog->created_at)->diffForHumans()  }}</span>
                    <p class="text">
                      @if(session()->get('language') == 'hindi') {!! Str::limit($blog->post_details_hin, 200 )  !!}
                      @else {!! Str::limit($blog->post_details_en, 200 )  !!} @endif
                    </p>
