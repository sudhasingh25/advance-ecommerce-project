...
<!-- ============================================== Testimonials: END ============================================== -->
    ...
    <div class="product-item-holder size-big single-product-gallery small-gallery">
        ...
        @foreach($multiImg as $m_img)

            <div class="single-product-gallery-item" id="slide{{$m_img->id}}">
                <a data-lightbox="image-1" data-title="Gallery" href="{{asset($m_img->photo_name)}}">
                    <img class="img-responsive" alt="" src="{{asset($m_img->photo_name)}}" data-echo="{{asset($m_img->photo_name)}}" />
                </a>
        ...
        <div class="single-product-gallery-thumbs gallery-thumbs">
            ...
            @foreach($multiImg as $m_img)
                <div class="item">
                    ...
                    <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="9" href="#slide{{$m_img->id}}">
                        <img class="img-responsive" width="85" alt="" src="{{asset($m_img->photo_name)}}" data-echo="{{asset($m_img->photo_name)}}" />
                    </a>
                </div>
            @endforeach
					...
					<div class="col-sm-8">
						<div class="reviews">
								...
								<div class="row">
									...
									<div class="col-sm-6">
                                        ...
                                        @else
											...
											<span class="price-strike"><i class="fa fa-inr" aria-hidden="true"></i>{{ $product->selling_price }}</span>
                                        @endif
										</div>
									</div>
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<div class="form-group">
										<label class="info-title control-label">Choose Colour <span>*</span></label>
									...
									<div class="product-tab">
										...
										<div class="product-add-review">
											...
											<div class="review-form">
												@guest
													<p><b>To add product review you need to login first 
...
<!-- Go to www.addthis.com/dashboard to customize your tools --> 
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-6354a4ef194ea7d3"></script>
