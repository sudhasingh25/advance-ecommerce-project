    ...
    <div class='row'>
                ...
                @foreach($categories as $category)
                    <div class="accordion-group">
                        <div class="accordion-heading"> <a href="#collapse{{ $category->id }}" data-toggle="collapse" class="accordion-toggle collapsed"> 
                            @if(session()->get('language') == 'hindi') {{ $category->category_name_hi }} @else {{ $category->category_name_en }} @endif </a> 
                        </div>
                    <!-- /.accordion-heading -->
                            ...
                            @foreach($subcategories as $subcategory)
                                <ul>
                                    <li><a href="{{ url('subcategory/product/'.$subcategory->id.'/'.$subcategory->subcategory_slug_en ) }}">
                                        @if(session()->get('language') == 'hindi') {{ $subcategory->subcategory_name_hi }} @else {{ $subcategory->subcategory_name_en }} @endif</a>
                                    </li>
      ...
      @foreach($breadsubsubcat as $item)
       ...
       @endforeach
        ...
        <span class="badge badge-danger" style="background: #FF0000">{{ $item->sub_subcategory_name_en }} </span>
       @endforeach
                      ...
                      <div class="row product-list-row">
                        ...
                        <div class="col col-sm-8 col-lg-8">
                          <div class="product-info">
                            <h3 class="name"><a href="{{url('product/details/'.$product->id.'/'.$product->product_slug_en)}}">
                            @if(session()->get('language') == 'hindi') {{ $product->product_name_hi }}
                            @else {{ $product->product_name_en }} @endif</a>
                            </h3>
                            <div class="rating rateit-small"></div>
                            <div class="product-price"> 
                            @if($product->discount_price == NULL)
