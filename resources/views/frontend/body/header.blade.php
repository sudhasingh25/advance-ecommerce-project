      ...
      <div class="header-top-inner">
        <div class="cnt-account">
          <ul class="list-unstyled">
            ...
            @if(session()->get('language') == 'hindi') कार्ट @else Cart  @endif</a></li>
            ...
            @if(session()->get('language') == 'hindi') ऑर्डर ट्रैकिंग @else Order Tracking  @endif
            ...
            @if(session()->get('language') == 'hindi') लॉग इन करें/अकाउंट बनाये @else Login/Register @endif</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
          ...
          @endphp 
          <!-- ============================================================= LOGO ============================================================= -->
          <div class="logo"> <a class="d-flex align-items-center justify-content-center" href="{{url('/')}}">
          <img src="{{ asset($setting->logo) }}" style="background-color:#fdd922; padding:10px; border-radius:50%;" alt="logo">
						  <span style="color:#ffffff; font-weight:bold; font-size:20px;">Shopee</span>
          </a> </div>
          <!-- /.logo --> 
          <!-- ============================================================= LOGO : END ============================================================= --> </div>
        <!-- /.logo-holder -->
            ...
            <div class="nav-outer">
              ...
              <li class="active dropdown yamm-fw"> 
                <a href="{{ url('/') }}" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">
                  @if(session()->get('language') == 'hindi') होम 
                  @else Home @endif
                </a> 
              </li>
            ...
            <!--   // Get SubCategory Table Data -->
              ...
              @foreach($subcategories as $subcategory)
                ...
                @foreach($subsubcategories as $subsubcategory)
                            <ul class="links">
                              <li><a href="{{ url('subsubcategory/product/'.$subsubcategory->id.'/'.$subsubcategory->sub_subcategory_slug_en ) }}">
                              @if(session()->get('language') == 'hindi') {{ $subsubcategory->sub_subcategory_name_hi }}
                             @else {{ $subsubcategory->sub_subcategory_name_en }} @endif
