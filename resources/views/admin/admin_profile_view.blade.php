...
<a href="{{route('admin.profile.edit')}}" class="btn btn-rounded btn-success mb-5" style="float:right">Edit Profile</a>
					...
					<div class="widget-user-image">
					  <img class="rounded-circle" style="width:80px; height:80px" src="{{(!empty($adminData->profile_photo_path))? url('upload/admin_images/'.$adminData->profile_photo_path): url('upload/no_image.png')}}" alt="User Avatar">
					</div>
