      ...
      <ul class="sidebar-menu" data-widget="tree">  
       ...
       @if($shipping == true)
        ...
        <li class="treeview {{ ($prefix == '/shipping')?'active':'' }}  ">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ ($route == 'manage-division')? 'active':'' }}"><a href="{{ route('manage-division') }}"><i class="ti-more"></i>Ship Sub-Division</a></li>
       ...
       @if($orders == true)
        ...
        <li class="treeview {{ ($prefix == '/orders')?'active':'' }}  ">
          ...
          <ul class="treeview-menu">
            <li class="{{ ($route == 'pending-orders')? 'active':'' }}"><a href="{{ route('pending-orders') }}">
              <i class="ti-more"></i>Pending Orders</a>
            </li>
...
<li class="{{ ($route == 'add.post')? 'active':'' }}"><a href="{{ route('add.post') }}"><i class="ti-more"></i>Add Blog Post</a></li>
    ...
    @if($review == true)
        ...
        <li class="treeview {{ ($prefix == '/review')?'active':'' }}  ">
          ...
          <ul class="treeview-menu">
        <li class="{{ ($route == 'pending.review')? 'active':'' }}"><a href="{{ route('pending.review') }}">
          <i class="ti-more"></i>Pending Review</a></li>

        <li class="{{ ($route == 'publish.review')? 'active':'' }}"><a href="{{ route('publish.review') }}">
          <i class="ti-more"></i>Publish Review</a></li>
          </ul>
        </li> 
    ...
    @if($stock == true)  
        <li class="treeview {{ ($prefix == '/stock')?'active':'' }}  ">
          ...
          <ul class="treeview-menu">
        <li class="{{ ($route == 'product.stock')? 'active':'' }}"><a href="{{ route('product.stock') }}">
