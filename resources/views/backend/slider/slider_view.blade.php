...
@section('admin')
 ...
 <td><img src="{{ asset($item->slider_img) }}" style="width: 70px; height: 40px;"> </td>
		...
		<td class="d-flex">
        <a href="{{ route('slider.edit',$item->id) }}" class="btn btn-info btn-sm mr-1" title="Edit Data"><i class="fa fa-pencil"></i> </a>

        <a href="{{ route('slider.delete',$item->id) }}" class="btn btn-danger btn-sm mr-1" title="Delete Data" id="delete">
