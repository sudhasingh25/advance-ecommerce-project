...
Route::post('/user/store/change/password',[IndexController::class,'UserStoreChangePassword'])->name('user.store.change.password');
...
//all sub sub category route
    Route::get('/sub/sub/view',[SubsubCategoryController::class,'SubSubCategoryView'])->name('all.subsubcategory');
    Route::get('/sub/subcategory/ajax/{category_id}',[SubsubCategoryController::class,'GetSubCategory']);
    Route::get('/sub/sub-subcategory/ajax/{subcategory_id}',[SubsubCategoryController::class,'GetSubSubCategory']);
...
Route::prefix('shipping')->group(function(){
  /*  
    ...
    Route::get('/division/ajax/{id}', [ShippingAreaController::class, 'GetDistrict']);*/
    Route::get('/state/view', [ShippingAreaController::class, 'StateView'])->name('manage-state');
    Route::post('/state/store', [ShippingAreaController::class, 'StateStore'])->name('state.store');
    Route::get('/state/edit/{id}', [ShippingAreaController::class, 'StateEdit'])->name('edit.ship.state');
    ...
    Route::get('/add-division/ajax/{state_id}', [ShippingAreaController::class, 'GetDistrict']);
    Route::get('/get-division/ajax/{district_id}', [ShippingAreaController::class, 'GetDivision']);
    Route::post('/division/store', [ShippingAreaController::class, 'DivisionStore'])->name('store.division');
    Route::get('/division/edit/{id}', [ShippingAreaController::class, 'DivisionEdit'])->name('division.edit');
    Route::post('/division/update/{id}', [ShippingAreaController::class, 'DivisionUpdate'])->name('update.division');
